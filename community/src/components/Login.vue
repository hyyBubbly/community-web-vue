<template>
	<div>
			...
			<div class="login_box">
				...
				<el-form ref="loginFormRef" :rules="loginRules" :model="loginForm" label-width="0" class="login_form">
					...
					<el-form-item prop="workNo">
						<el-input v-model="loginForm.workNo" prefix-icon="iconfont icon-denglu"
							placeholder="用戶账号"></el-input>
					</el-form-item>
					<!-- 密码 -->
					<el-form-item prop="password">
						<el-input v-model="loginForm.password" prefix-icon="iconfont icon-mima" show-password
							placeholder="密碼"></el-input>
					</el-form-item>
					<!-- 角色 -->
					<el-form-item prop="roleId">
						<el-select v-model="loginForm.roleId" clearable placeholder="请选择角色">
							<el-option v-for="item in options" :key="item.roleId" :label="item.role" :value="item.roleId">
							</el-option>
						</el-select>
					</el-form-item>
					<!-- 按钮 -->
					<el-form-item class="btns">
						<el-link @click="isRegister = true" style="margin-right: 10px; color: #409EFF"
							:underline="false">没有账号，注册</el-link>
		...
		<el-dialog title="注册页面" :visible.sync="isRegister" :with-header="false" width="50%" @close="editClosed">
